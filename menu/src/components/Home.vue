  ...
  <van-pull-refresh class="van-pull" v-model="isLoading" @refresh="onRefresh">
    <div class="home">
      ...
      <div class="classification">
        ...
        {{sort}}
        <van-swipe :loop="false" :width="300" :height="160" :show-indicators="false">
    ...
    GetDataServe() {
      ...
      this.$axios
        ...
        .then(res => {
          ...
          for (let i = 0; i < res.data.result.features_list.list.length; i++) {
            // console.log(i);
            this.today.push(res.data.result.features_list.list[i].r);
          }
          this.today.shift();
